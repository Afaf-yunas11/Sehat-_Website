    ...
    <Modal.Footer>
      <div className="d-flex justify-content-between align-items-center w-100">
        ...
        <Button
          ...
          className="me-3"
        >
          Estimated Cost: {rooms && rooms[selectedRoomIndex] && procedureCost
            ? (`PKR ${parseInt(rooms[selectedRoomIndex].ROOM_COST_PER_NIGHT || 0) * parseInt(newAppointment.DURATION_OF_STAY || 0) + parseInt(procedureCost.procedureCost || 0)}`)
            : ``}
        </Button>
        <div>
